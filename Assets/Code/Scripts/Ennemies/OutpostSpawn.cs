...
public class OutpostSpawn : MonoBehaviour
{
    ...
    [SerializeField] private float radius = 20000f;
    ...
    private void Start()
    {
        ...
        for (var i = 0; i < numberOfOutposts; i++)
        {
            ...
            var spawnPosition = new Vector3(coordX, Terrain.activeTerrain.SampleHeight(new Vector3(coordX, 0, coordY)) - 4000, coordY);
