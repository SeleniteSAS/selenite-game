...
public class GunBehavior : MonoBehaviour
{
    ...
    [SerializeField] public Image reloadBar; // Référence à l'image de la barre de rechargement
    ...
    [SerializeField] public float reloadRate = 10f; // Taux de rechargement par seconde
